...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).select().apis(RequestHandlerSelectors.basePackage("com.zmhomecn")).paths(PathSelectors.any()).build();
    }
    /**
     * 创建api文档信息
     * @return
